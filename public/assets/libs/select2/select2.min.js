!(function(e) {
    ...
    var t = (function() {
            ...
            function A(e) {
                ...
                return (-1 < n &&
                    ((t = e.substring(0, n)),
                        (e = e.substring(n + 1, e.length))), [t, e]
                );
            }
            ...
            return (
                ...
                (t ? (r = t) : (t = {}),
                    ...
                    (l = function(e, t) {
                        ...
                        return (
                            ...
                            ((o = (i = A((e = y(e, s))))[0]),
                                (e = i[1]),
                                o && (n = w(o))), { f: o ? o + "!" + e : e, n: e, pr: o, p: n }
                        );
                    }),
                    (c = {
                        require: function(e) {
                    ...
                    (s = function(e, t, n, r) {
                        ...
                        if (
                            ...
                            for (
                                ...
                                if ("require" === (s = (p = l(t[f], g)).f))
                                    y[f] = c.require(e);
                                else if ("exports" === s)
                                (y[f] = c.exports(e)), (m = !0);
                            else if ("module" === s) i = y[f] = c.module(e);
                            else if (v(u, s) || v(d, s) || v(h, s))
                                y[f] = w(s);
                            else {
                                if (!p.p)
                                    throw new Error(e + " missing " + s);
                                p.p.load(p.n, _(r, !0), b(s), {}),
                                    (y[f] = u[s]);
                            }
                            (a = n ? n.apply(u[e], y) : void 0),
                            e &&
                                (i && i.exports !== o && i.exports !== u[e] ?
                                    (u[e] = i.exports) :
                                    (a === o && m) || (u[e] = a));
                        } else e && (u[e] = n);
                    }),
                    (n =
                        ...
                        function(e, t, n, r, i) {
                            if ("string" == typeof e)
                                return c[e] ? c[e](t) : w(l(e, x(t)).f);
                            if (!e.splice) {
                                if (
                                    ((p = e).deps && a(p.deps, p.callback), !t)
                                )
                                    return;
                                t.splice ?
                                    ((e = t), (t = n), (n = null)) :
                            ...
                            (n.prototype.option = function(n) {
                                ...
                                if (n.children) {
                                    ...
                                    e(c),
                                        this.template(n, c);
                                    for (
                                        var u = [], d = 0; d < n.children.length; d++
                                    ) {
                                        var p = n.children[d],
                                            h = this.option(p);
                                        u.push(h);
                ...
                t.define(
                    ...
                    function(e, t, n) {
                        ...
                        return (
                            ...
                            (r.prototype._handleKeyboardClear = function(
                                e,
                                n,
                                r
                            ) {
                ...
                t.define(
                    "select2/selection/eventRelay", ["jquery"],
                    function(e) {
                        function t() {}
                        return (
                                ...
                                t.call(this, n, r),
                                    n.on("*", function(t, n) {
                                        if (-1 !== e.inArray(t, o)) {
                                            ...
                                            i.$element.trigger(r), -1 !== e.inArray(t, s) &&
                                                (n.prevented =
                    ...
                    function(e, t, n) {
                        ...
                        return (
                            ...
                            (r.prototype.item = function(e) {
                                ...
                                return (
                                    ((r = this._normalizeItem(r)).element =
                                        e[0]),
                            ...
                            (r.prototype._normalizeItem = function(e) {
                                return (
                                    ...
                                    n.extend({}, { selected: !1, disabled: !1 },
                                        e
                                    )
                                );
                            }),
                        ...
                        (t.prototype.query = function(e, t, n) {
                            ...
                            this._removeOldTags(),
                                ...
                                e.call(this, t, function e(i, o) {
                                    for (
                                        var s = i.results, a = 0; a < s.length; a++
                                    ) {
                                        var l = s[a],
                                            c =
                                            null != l.children &&
                ...
                t.define("select2/dropdown/hidePlaceholder", [], function() {
                    ...
                    return (
                        ...
                        (e.prototype.removePlaceholder = function(e, t) {
                            for (
                                var n = t.slice(0), r = t.length - 1; 0 <= r; r--
                            ) {
                                var i = t[r];
                        ...
                        return (
                            ...
                            (n.prototype.render = function(t) {
                                var n = e("<span></span>"),
                                    r = t.call(this);
                                return (
                                    n.append(r), (this.$dropdownContainer = n)
                                );
                            }),
                ...
                t.define(
                    "select2/dropdown/selectOnClose", ["../utils"],
                    function(e) {
                        function t() {}
                        return (
                            (t.prototype.bind = function(e, t, n) {
                            ...
                            (O.prototype.apply = function(u) {
                                if (
                                    ...
                                    if (null != u.initSelection) {
                                        var C = t(
                                            u.amdBase + "compat/initSelection"
                                        );
                                        u.dataAdapter = c.Decorate(
                                            u.dataAdapter,
                                            C
                                ...
                                u.language.push("en");
                                for (
                                    var L = [], I = 0; I < u.language.length; I++
                                ) {
                                    var j = u.language[I]; -
                    ...
                    function(e, t, n, r) {
                        ...
                        return (
                            (i.prototype.fromElement = function(e) {
                                ...
                                for (
                                    var s = 0; s < e[0].attributes.length; s++
                                ) {
                    ...
                    function(e, t, n, r) {
                        ...
                        return (
                            ...
                            (i.prototype._resolveWidth = function(e, t) {
                                ...
                                for (
                                    var s = o.split(";"), a = 0, l = s.length; a < l; a += 1
                                ) {
                            ...
                            (i.prototype._registerSelectionEvents =
                                function() {
                                    var t = this,
                                        n = ["toggle", "focus"];
                                ...
                                if (!t ||
                                    ...
                                    if (n)
                                        if (
                                            ...
                                            for (
                                                var o = 0; o < n.addedNodes.length; o++
                                            )
                                                n.addedNodes[o].selected &&
                                                (r = !0);
                                        else
                                            n.removedNodes &&
                                            0 < n.removedNodes.length ?
                                            (r = !0) :
                                            e.isArray(n) &&
