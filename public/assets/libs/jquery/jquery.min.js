!(function(e, t) {
    ...
    w.extend({
            ...
            each: function(e, t) {
                ...
                if (T(e))
                    for (
                        n = e.length; r < n && !1 !== t.call(e[r], r, e[r]); r++
                    );
                else
                    for (r in e)
                        ...
                        return (
                            ...
                            ((h = (d = a).documentElement),
                                ...
                                (n.getById = ce(function(e) {
                                    return (
                                        (h.appendChild(e).id = b), !d.getElementsByName ||
            ...
            (u = se.select =
                function(e, t, n, i) {
                    ...
                    if (((n = n || []), 1 === d.length)) {
                        ...
                        for (
                            o = G.needsContext.test(e) ? 0 : u.length; o-- && ((l = u[o]), !r.relative[(c = l.type)]);
    ...
    w.fn.extend({
        ...
        is: function(e) {
            return !!j(
                this,
                "string" == typeof e && k.test(e) ? w(e) : e || [], !1
            ).length;
        },
    });
    var D,
                ...
                if (
                    ((t = t instanceof w ? t[0] : t),
                        w.merge(
                            ...
                            w.parseHTML(
                                r[1],
                                t && t.nodeType ? t.ownerDocument || t : v, !0
                            )
                        ),
    ...
    function He(e, t, n, r) {
        ...
        if (
            ...
            if (u)
                for (
                    c = s[s.length - 1].ownerDocument, w.map(s, qe), f = 0; f < u; f++
                )
                    (l = s[f]),
                    he.test(l.type || "") &&
    ...
    w.extend({
        ...
        w.each({
            ...
            function(e, t) {
                w.fn[e] = function(e) {
                    for (
                        var n, r = [], i = w(e), o = i.length - 1, s = 0; s <= o; s++
                    )
    ...
    function lt(e, t, n) {
        var r,
            ...
            l = s.promise({
                elem: e,
                props: w.extend({}, t),
                opts: w.extend(!0, { specialEasing: {}, easing: w.easing._default },
                    n
                ),
                ...
                select: {
                    ...
                    set: function(e, t) {
                        for (
                            ...
                            ((r = i[a]).selected = -1 < w.inArray(w.valHooks.option.get(r), o)) &&
                            (n = !0);
    ...
    w.ajaxSetup({
        ...
        w.fn.extend({
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (
                        var e = this.offsetParent; e && "static" === w.css(e, "position");
